...
const skillsData = [
  {
    ...
    skills: ['LangGraph', 'LangChain', 'Agentic RAG', 'Multi-Agent Systems (MoE)', 'Model Context Protocol (MCP)', 'Tool-Calling', 'LlamaIndex', 'Self-RAG', 'CRAG', 'LoRA Fine-tuning'],
  },
  {
    id: "retrieval-search",
    icon: Search,
    title: 'Retrieval & Search',
    skills: ['Hybrid Search (BM25 + Dense)', 'Reciprocal Rank Fusion', 'Cross-Encoder Re-ranking', 'Cosine Similarity Scoring', 'Semantic Caching', 'Sentence-Transformers', 'HuggingFace Transformers'],
  },
  {
    id: "llms-vector-db",
    icon: Database,
    title: 'LLMs & Vector Databases',
    skills: ['Qdrant', 'pgvector', 'Pinecone', 'MedCPT', 'DeepSeek-R1/R2', 'Groq', 'Ollama', 'vLLM', 'OpenAI API', 'AWS Bedrock', 'Llama 3.x', 'Qwen 2.5/3'],
  },
  {
    id: "ml-evaluation",
    icon: LineChart,
    title: 'ML & Evaluation',
    skills: ['Scikit-learn', 'LightGBM', 'XGBoost', 'TensorFlow/Keras', 'MLflow', 'RAGAS', 'RapidFuzz', 'NDCG', 'Hallucination Detection', 'Drift Detection', 'Citation Accuracy', 'pytest'],
  },
  {
    id: "fullstack-backend",
    icon: Layers,
    title: 'Full Stack, Backend & Automation',
    skills: ['FastAPI', 'REST APIs', 'React 18', 'TypeScript', 'Python', 'Playwright', 'PostgreSQL', 'MongoDB', 'SQLite', 'DuckDB', 'Redis', 'SQLAlchemy', 'Pydantic', 'Docker', 'PyWebView'],
  },
  {
    id: "cloud-security",
    icon: ShieldCheck,
    title: 'Cloud, Deployment & Security',
    skills: ['AWS', 'Oracle OCI', 'GCP', 'Cloudflare Pages', 'Kubernetes', 'OAuth2', 'JWT', 'AES-GCM', 'HIPAA & GDPR', 'Prometheus', 'Linux', 'Git'],
  },
];
